...
//`user_ID`, `user_firstName`, `user_lastName`, `user_isManager`, `user_login`, `user_password` FROM `mm_users`
    ...
    <div class="wrapper">
        ...
        <section class="frame">
            ...
            <div class="article">
                ...
                <h3>User '<?php echo $firstName . " " . $lastName ?>'' has been created.</h3>
            </div>
        </section>
        <div class="footer">
